...
//             {/* Optional text */}
//             <div className="absolute bottom-10 left-10 z-10 max-w-2xl text-white space-y-4 bg-gradient-to-r from-black/70 to-transparent p-6 rounded-xl backdrop-blur-md shadow-lg">
...
//   <div>
//     <button className="bg-red-600 hover:bg-red-700 text-white px-5 py-2 rounded-full font-semibold text-sm shadow-md transition">
//       ▶ Watch Now
//     </button>
//   </div>
// </div>
...
//       <div className="absolute top-0 left-0 w-full h-full px-4 flex items-center justify-between z-10 opacity-0 group-hover:opacity-100 transition-opacity">
//         <button
//           className="bg-white/80 hover:bg-white text-black p-2 rounded-full text-xl"
//           onClick={handlePrev}
//         >
//           <IoIosArrowBack />
//         </button>
